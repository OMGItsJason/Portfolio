<script>
	...
	import MapMarker from '$lib/svg/map-marker.svg';
...
<aside
	class="flex flex-col items-center sm:items-start text-center pt-14 sm:text-start sm:pt-0 sm:block sm:mt-14 sm:h-auto sm:w-64 sm:fixed sm:z-10"
>
